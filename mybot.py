...
bot_token = '7413383036:AAFMuVpqUMVrp_9ILG_CAACfM_KRcH6336Q'
...
async def confirm_payment(client, message: Message):
    ...
    try:
        ...
        if order_id in pending_orders:
            ...
            location_url = "https://t.me/necroimg_bot?start=photo00e20164a81"  # замените на реальную ссылку на координаты товара
